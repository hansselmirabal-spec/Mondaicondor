      ...
      <div className="max-w-2xl">
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-1">
            <h1 className="text-2xl font-bold text-gray-900">UENs</h1>
            <HelpTip title="UENs">
              <p>Las UENs (Unidades Estratégicas de Negocio) sirven para etiquetar tareas por unidad de negocio.</p>
              <p>Una misma tarea puede tener más de una UEN asignada.</p>
            </HelpTip>
          </div>
